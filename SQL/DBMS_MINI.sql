...
CREATE TABLE CUSTOMER(
    ...
    insert into customer values('Naitik', 'parmar@gmail.com', 'test', 'M', 'new', 'Kankroli',313324, 9414174, 12);
...
CREATE TABLE ROUTE(
    ...
    CITY_CODE VARCHAR(10),
    CONSTRAINT PK_START_ROUTE PRIMARY KEY(ROUTE_ID, CITY_HIERARCHY),
    CONSTRAINT FK1_START_ROUTE FOREIGN KEY(CITY_CODE) REFERENCES CITY(CITY_CODE) ON DELETE CASCADE ON UPDATE CASCADE);
...
CREATE TABLE VEHICLE(
    ...
    CONSTRAINT FK1_VEHICLE FOREIGN KEY(ROUTE_ID, CITY_HIERARCHY) REFERENCES ROUTE(ROUTE_ID, CITY_HIERARCHY) ON DELETE SET NULL ON UPDATE CASCADE,
